...
drag_no_polymer = np.load("results/arrays/experiments/10007/drag_coeff.npy")[:800]
...
drag_polymer3 = np.load("results/arrays/experiments/10009/drag_coeff.npy")[:800]
...
dp3= np.divide(drag_no_polymer-drag_polymer3,drag_no_polymer) * 100
...
plt.savefig("plots/experiments/10009/" + "drag_comparison_with_no_polymer.png")
